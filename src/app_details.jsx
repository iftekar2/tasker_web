  ...
  return (
    <AppDetailsContainer>
      <AppDetailsSection>
        ...
        <PageDescription>
          Forget endless tabs and review scrolling. Your local hands you the
          kind of itinerary friends used to share on napkins — only better.
        </PageDescription>
        ...
        <ReasonToUseApp>
          ...
          <li>
            ...
            <div>
              ...
              <p>
                Restaurant closed unexpectedly? Weather changed plans? Your
                local is one message away.
              </p>
            </div>
          </li>
        </ReasonToUseApp>
